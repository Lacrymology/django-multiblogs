...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('multiblogs_post', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multiblogs.PostStatus'], null=True))
    ...
    models = {
        ...
        'multiblogs.post': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['multiblogs.PostStatus']", 'null': 'True'}),
